...
export default function AdminArtifactsPage() {
    ...
    try {
      ...
      setErrorMessage(
        error instanceof Error
          ? error.message
          : "Failed to mint artifact. Make sure you're the contract owner or have minter permissions."
      );
    } finally {
      setIsMinting(false);
    }
  ...
  if (!isSignedIn) {
    return (
      <>
        <Head>
          <title>Admin - Create Artifact - Mystic Island</title>
          <meta name="description" content="Admin page to mint new artifact NFTs" />
        </Head>
        <PageContainer>
          <Container>
            <BackLink href="/admin">← Back to Admin</BackLink>
            <Header>
              <Title>Admin - Create Artifact</Title>
    ...
    <>
      ...
      <PageContainer>
        <Container>
          ...
          <InfoBox>
            <InfoTitle>ℹ️ Admin Information</InfoTitle>
            <InfoText>
              <strong>Permissions:</strong> Only contract owners and authorized minters can mint artifacts.
            </InfoText>
            <InfoText>
